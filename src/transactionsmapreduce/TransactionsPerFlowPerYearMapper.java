...
public class TransactionsPerFlowPerYearMapper extends Mapper<Object, Text, IntStringCompositeKeyWritable, IntWritable> {
    ...
    public void map(Object key, Text value, Context context) throws IOException,
        ...
        //Check if flow column is empty. If it is, return.
        ...
        context.write(new IntStringCompositeKeyWritable(year, flow),
                new IntWritable(1));
    }
